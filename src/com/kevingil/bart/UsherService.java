...
// TODO: Look at Intent to send on notification click to ENSURE stop service label is created in MainActivity
...
public class UsherService extends Service {
    ...
    public int onStartCommand(Intent intent, int flags, int startId) {
    	...
    	usherRoute = MainActivity.usherRoute;
            ...
            //new CountDownTimer(5000, 1000){
    			...
    			public void onFinish() {
    				...
    				if ((usherRoute.legs.size() == currentLeg+1) && !didBoard){
    			        ...
    			        notification = builder.getNotification();
    			        mNM.notify(NOTIFICATION, notification);
    			        //MainActivity.removeStopServiceText();
    			        stopSelf();
    				}
    ...
    private BroadcastReceiver serviceDataMessageReceiver = new BroadcastReceiver() {
  	...
  	//04-11 18:24:42.420: E/AndroidRuntime(6698): 	at com.kevingil.bart.UsherService.updateTimersWithEtdResponse(UsherService.java:319)
